...
function create_fragment(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(document.body, "click", /*onClose*/ ctx[3]);
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [x, y, menuEl, onClose, div_binding];
}

class TJSContextMenu extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { x: 0, y: 1 }, add_css);
	}
}
