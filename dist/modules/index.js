...
function add_css(target) {
	append_styles(target, "svelte-xzns5h", ".typhonjs-app{max-height:100%;background:url(/ui/denim075.png) repeat;border-radius:5px;box-shadow:0 0 20px #000;margin:3px 0;color:#f0f0e0;position:absolute}.typhonjs-window-app{display:flex;flex-direction:column;flex-wrap:nowrap;justify-content:flex-start;padding:0;z-index:99}.typhonjs-window-app .window-content.svelte-xzns5h{display:flex;flex-direction:column;flex-wrap:nowrap;justify-content:flex-start;padding:8px;color:#191813;overflow-y:auto;overflow-x:hidden}");
}
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			create_component(container.$$.fragment);
			attr(section, "class", "window-content svelte-xzns5h");
