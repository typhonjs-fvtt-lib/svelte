...
function add_css(target) {
	append_styles(target, "svelte-5y3hks", ".tjs-context-menu.svelte-5y3hks.svelte-5y3hks.svelte-5y3hks{position:fixed;width:fit-content;font-size:14px;box-shadow:0 0 10px #000;height:max-content;min-width:150px;max-width:360px;background:#23221d;border:1px solid #000;border-radius:5px;color:#EEE;z-index:10000}.tjs-context-menu.svelte-5y3hks ol.tjs-context-items.svelte-5y3hks.svelte-5y3hks{list-style:none;margin:0;padding:0}.tjs-context-menu.svelte-5y3hks li.tjs-context-item.svelte-5y3hks.svelte-5y3hks{padding:0 5px;line-height:32px}.tjs-context-menu.svelte-5y3hks li.tjs-context-item.svelte-5y3hks.svelte-5y3hks:hover{color:#FFF;text-shadow:0 0 4px red}.tjs-context-menu.svelte-5y3hks li.tjs-context-item.svelte-5y3hks>i.svelte-5y3hks{margin-right:5px}");
}
...
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			i = element("i");
			t = text(t_value);
			attr(i, "class", i_class_value = "" + (null_to_empty(/*item*/ ctx[13].icon) + " svelte-5y3hks"));
			attr(li, "class", "tjs-context-item svelte-5y3hks");
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*items*/ 2 && i_class_value !== (i_class_value = "" + (null_to_empty(/*item*/ ctx[13].icon) + " svelte-5y3hks"))) {
				attr(i, "class", i_class_value);
			}
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(ol, "class", "tjs-context-items svelte-5y3hks");
			attr(nav, "id", /*id*/ ctx[0]);
			attr(nav, "class", "tjs-context-menu svelte-5y3hks");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*onClick, items, localize*/ 18) {
...
const _excluded = ["async", "id", "x", "y", "items"];
/**
...
class TJSMenu {
   ...
   */
  static async createContext(_ref = {}) {
    let {
      async = false,
      id = '',
      x = 0,
    ...
    if (_classStaticPrivateFieldSpecGet(this, TJSMenu, _contextMenuData).active) {
      return;
    } // Set the active state to true. This provides the latch above when async is enabled.


    _classStaticPrivateFieldSpecGet(this, TJSMenu, _contextMenuData).active = true; // Destroy the existing menu an play the outro transition.
    ...
    if (_classStaticPrivateFieldSpecGet(this, TJSMenu, _contextMenu) !== void 0) {
      ...
      _classStaticPrivateFieldSpecSet(this, TJSMenu, _contextMenu, void 0); // Await on outroAndDestroy when async is enabled otherwise immediately continue.
    ...
    _classStaticPrivateFieldSpecSet(this, TJSMenu, _contextMenu, new TJSContextMenu({
      ...
      props: {
        id,
        x: _classStaticPrivateFieldSpecGet(this, TJSMenu, _contextMenuData).x,
        y: _classStaticPrivateFieldSpecGet(this, TJSMenu, _contextMenuData).y,
        items,
        transitionOptions
      }
    ...
    _classStaticPrivateFieldSpecGet(this, TJSMenu, _contextMenuData).active = false;
  }
