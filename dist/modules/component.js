...
function create_fragment$1(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			append(div, t);
			append(div, section);
			mount_component(tjscontainer, section, null);
		...
		d(detaching) {
			...
			destroy_component(tjscontainer);
...
export { TJSApplicationHeader, TJSApplicationShell, TJSComponentShell, TJSContainer, TJSContextMenu, TJSHeaderButton };
