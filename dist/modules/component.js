import { SvelteComponent, init, safe_not_equal, flush, append_styles, empty, insert, group_outros, transition_out, check_outros, transition_in, detach, element, attr, noop, create_component, mount_component, get_spread_update, get_spread_object, destroy_component, destroy_each, assign, text, append, listen, set_data, space, binding_callbacks, create_slot, update_slot_base, get_all_dirty_from_scope, get_slot_changes, null_to_empty, set_style, add_render_callback, create_bidirectional_transition, globals, current_component } from 'svelte/internal';
...
class TJSContainer extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$6, create_fragment$6, safe_not_equal, { warn: 0, children: 1 }, add_css$2);
	}
...
function create_each_block$1(ctx) {
	let tjsheaderbutton;
	let current;
	tjsheaderbutton = new TJSHeaderButton({ props: { button: /*button*/ ctx[2] } });
...
function create_if_block$1(ctx) {
	let tjscontainer;
	let current;
	tjscontainer = new TJSContainer({ props: { children: /*children*/ ctx[5] } });
...
class ApplicationShell extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { title: 6, zIndex: 0 });
	}
...
class TJSApplicationShell extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { title: 6, zIndex: 0 }, add_css$1);
	}
