import { SvelteComponent, init, safe_not_equal, append_styles, empty, insert, group_outros, transition_out, check_outros, transition_in, detach, element, attr, noop, create_component, mount_component, get_spread_update, get_spread_object, destroy_component, destroy_each, assign, text, append, listen, set_data, space, binding_callbacks, null_to_empty, set_style, add_render_callback, create_bidirectional_transition, globals, current_component } from 'svelte/internal';
...
/* src\modules\component\Container.svelte generated by Svelte v3.44.1 */
...
/* src\modules\component\ComponentShell.svelte generated by Svelte v3.44.1 */
...
/* src\modules\component\application\HeaderButton.svelte generated by Svelte v3.44.1 */
...
/* src\modules\component\application\ApplicationHeader.svelte generated by Svelte v3.44.1 */
...
function create_each_block(ctx) {
	...
	let i;
	let i_class_value;
	let t_value = localize$1(/*item*/ ctx[15].label) + "";
	let t;
	let mounted;
	let dispose;
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*items*/ 2 && t_value !== (t_value = localize$1(/*item*/ ctx[15].label) + "")) set_data(t, t_value);
		},
		d(detaching) {
...
export { ApplicationHeader, ApplicationShell, ComponentShell, Container, HeaderButton, TJSContextMenu };
