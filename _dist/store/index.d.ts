...
declare class DynArrayReducer<T> {
     ...
     */
    static "__#319574@#isIterable"(data: any): boolean;
    /**
...
declare class LocalStorage {
     ...
     */
    static "__#319575@#createStore"(key: string, defaultValue?: boolean): svelte_store.Writable<any>;
    /**
...
declare class SessionStorage {
     ...
     * @returns {LSStore} The new LSStore.
     */
    static "__#319576@#createStore"(key: string, defaultValue?: boolean): svelte_store.Writable<any>;
    /**
...
declare class TJSGameSettings {
     ...
     */
    static "__#319579@#createStore"(initialValue: string): svelte_store.Writable<any>;
    /**
