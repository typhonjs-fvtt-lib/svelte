import { isObject, uuidv4, debounce, klona, isIterable, hasPrototype } from '@typhonjs-fvtt/svelte/util';
import { derived, get, writable as writable$2 } from 'svelte/store';
import { noop, run_all, is_function } from 'svelte/internal';
import { uuidv4 as uuidv4$1, isPlainObject, getUUIDFromDataTransfer, isObject as isObject$1 } from '@typhonjs-fvtt/svelte/util';
...
class TJSDocument
{
   ...
   {
      this.#uuidv4 = `tjs-document-${uuidv4$1()}`;
...
export { ArrayObjectStore, CrudArrayObjectStore, DerivedArrayReducer, DerivedMapReducer, DynArrayReducer, DynMapReducer, KeyStore, ObjectEntryStore, TJSDocument, TJSDocumentCollection, TJSLocalStorage, TJSSessionStorage, gameState, isReadableStore, isUpdatableStore, isWritableStore, propertyStore, storeCallback, subscribeFirstRest, subscribeIgnoreFirst, writableDerived };
