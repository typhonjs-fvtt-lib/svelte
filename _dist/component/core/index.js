...
class TJSContainer extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$d, create_fragment$d, safe_not_equal, { warn: 0, children: 1 }, add_css$4);
	}
...
class TJSComponentShell extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$c, create_fragment$c, safe_not_equal, { children: 1 });
	}
...
class ResizableHandle extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$8, create_fragment$8, safe_not_equal, { isResizable: 6 });
	}
}
...
function create_if_block_2(ctx) {
	...
	let switch_instance_anchor;
	let current;
	const switch_instance_spread_levels = [/*dialogProps*/ ctx[4]];
	var switch_value = /*dialogComponent*/ ctx[3];
	...
	return {
		...
		p(ctx, dirty) {
			const switch_instance_changes = (dirty & /*dialogProps*/ 16)
			? get_spread_update(switch_instance_spread_levels, [get_spread_object(/*dialogProps*/ ctx[4])])
			: {};

			if (switch_value !== (switch_value = /*dialogComponent*/ ctx[3])) {
				if (switch_instance) {
					group_outros();
					const old_component = switch_instance;
...
function create_fragment$4(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (typeof /*content*/ ctx[1] === 'string') return 0;
		if (/*dialogComponent*/ ctx[3]) return 1;
		return -1;
	}
	...
	let if_block1 = /*buttons*/ ctx[2].length && create_if_block$2(ctx);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*data*/ 128) {
			...
			$$invalidate(2, buttons = typeof data.buttons !== 'object'
			? []
		...
		if ($$self.$$.dirty & /*data, content*/ 130) {
			{
				$$invalidate(1, content = data.content);

				try {
					if (isSvelteComponent(content)) {
						$$invalidate(3, dialogComponent = content);
						$$invalidate(4, dialogProps = {});
					} else if (typeof content === 'object') {
						const svelteConfig = parseSvelteConfig(content, foundryApp);
						$$invalidate(3, dialogComponent = svelteConfig.class);
						$$invalidate(4, dialogProps = svelteConfig.props ?? {});
						...
						if (Array.isArray(children)) {
							$$invalidate(4, dialogProps.children = children, dialogProps);
						}
					} else {
						$$invalidate(3, dialogComponent = void 0);
						$$invalidate(4, dialogProps = {});
					}
				} catch(err) {
					$$invalidate(3, dialogComponent = void 0);
					$$invalidate(4, dialogProps = {});
					$$invalidate(1, content = err.message);
					console.error(err);
				}
			}
		}
...
/* src\component\core\dialog\document\TJSDocumentCreate.svelte generated by Svelte v3.46.0 */
