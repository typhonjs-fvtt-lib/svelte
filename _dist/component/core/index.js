...
function create_fragment$8(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(a, "click", prevent_default(/*onClick*/ ctx[1]));
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
