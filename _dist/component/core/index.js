...
import { outroAndDestroy, isSvelteComponent, parseSvelteConfig } from '@typhonjs-fvtt/svelte/util';
...
class TJSContainer extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$b, create_fragment$b, safe_not_equal, { warn: 0, children: 1 }, add_css$5);
	}
...
class TJSComponentShell extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$a, create_fragment$a, safe_not_equal, { children: 1 });
	}
...
class TJSHeaderButton extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$8, create_fragment$8, safe_not_equal, { button: 0 });
	}
...
class ResizableHandle extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$6, create_fragment$6, safe_not_equal, { isResizable: 5 });
	}
}
...
function create_else_block_1$1(ctx) {
	...
	return {
		c() {
			...
			attr(section, "style", /*styleContent*/ ctx[8]);
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(div, "pointerdown", /*bringToTop*/ ctx[11], true);
				mounted = true;
			}
		},
		p(new_ctx, dirty) {
			...
			if (!current || dirty & /*styleContent*/ 256) {
				attr(section, "style", /*styleContent*/ ctx[8]);
			}
...
// (138:9) {#if Array.isArray(allChildren)}
...
function instance$5($$self, $$props, $$invalidate) {
	...
	let { styleApp = void 0 } = $$props;
	let { styleContent = void 0 } = $$props;
	...
	$$self.$$set = $$props => {
		...
		if ('styleApp' in $$props) $$invalidate(7, styleApp = $$props.styleApp);
		if ('styleContent' in $$props) $$invalidate(8, styleContent = $$props.styleContent);
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*outTransition, foundryApp*/ 514) {
			{
				// Handle cases if outTransition is unset; assign noop default transition function.
				if (typeof outTransition !== 'function') {
					$$invalidate(1, outTransition = s_DEFAULT_TRANSITION);
...
class ApplicationShell extends SvelteComponent {
	...
	set styleContent(styleContent) {
		this.$$set({ styleContent });
		flush();
	}
...
// (157:11) {#if Array.isArray(allChildren)}
...
// (138:11) {#if Array.isArray(allChildren)}
...
/* src\component\core\contextmenu\TJSContextMenu.svelte generated by Svelte v3.44.3 */
