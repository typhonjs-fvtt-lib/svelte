...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(div, "id", div_id_value = /*application*/ ctx[10].id);
			attr(div, "class", div_class_value = "app window-app tjs-app tjs-window-app " + /*application*/ ctx[10].options.classes.join(' '));
			attr(div, "data-appid", div_data_appid_value = /*application*/ ctx[10].appId);
		},
		m(target, anchor) {
			insert(target, div, anchor);
		...
		p(new_ctx, [dirty]) {
			...
			if (!current || dirty & /*application*/ 1024 && div_class_value !== (div_class_value = "app window-app tjs-app tjs-window-app " + /*application*/ ctx[10].options.classes.join(' '))) {
				attr(div, "class", div_class_value);
			}
