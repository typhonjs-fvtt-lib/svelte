import { SvelteComponent, init, safe_not_equal, flush, append_styles, empty, insert, group_outros, transition_out, check_outros, transition_in, detach, element, attr, noop, destroy_each, create_component, mount_component, get_spread_update, get_spread_object, destroy_component, assign, create_slot, listen, update_slot_base, get_all_dirty_from_scope, get_slot_changes, add_render_callback, create_in_transition, create_out_transition, binding_callbacks, HtmlTag, text, append, stop_propagation, prevent_default, action_destroyer, set_data, is_function, run_all, component_subscribe, space, set_style, add_resize_listener, update_keyed_each, destroy_block, toggle_class, bind, add_flush_callback } from 'svelte/internal';
