import * as _typhonjs_svelte_runtime_base_svelte_component_container from '@typhonjs-svelte/runtime-base/svelte/component/container';
...
> {
  ...
  set padToVisualEdge(_: _typhonjs_svelte_runtime_base_svelte_action_dom_style.VisualEdgeSides);

  /** Getter for {@link ApplicationShell.Props.padToVisualEdge | padToVisualEdge} prop. */
  get padToVisualEdge(): _typhonjs_svelte_runtime_base_svelte_action_dom_style.VisualEdgeSides;

  /** Setter for {@link ApplicationShell.Props.scrollContainer | scrollContainer} prop. */
  set scrollContainer(_: boolean | _typhonjs_svelte_runtime_base_svelte_component_container.TJSScrollContainerData);

  /** Getter for {@link ApplicationShell.Props.scrollContainer | scrollContainer} prop. */
...
> {
  ...
  /** Setter for {@link TjsApplicationShell.Props.scrollContainer | scrollContainer} prop. */
  set scrollContainer(_: boolean | _typhonjs_svelte_runtime_base_svelte_component_container.TJSScrollContainerData);

  /** Getter for {@link TjsApplicationShell.Props.scrollContainer | scrollContainer} prop. */
  get scrollContainer(): boolean | _typhonjs_svelte_runtime_base_svelte_component_container.TJSScrollContainerData;
...
export { AppShell, ApplicationShell, EmptyApplicationShell, TjsApplicationShell as TJSApplicationShell };
