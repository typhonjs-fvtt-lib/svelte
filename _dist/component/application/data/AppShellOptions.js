import { applyVisualEdgeInsets } from '@typhonjs-svelte/runtime-base/svelte/action/dom/style';
...
export class AppShellOptions
{
    ...
    *
    * @param {import('@typhonjs-svelte/runtime-base/svelte/action/dom/style').VisualEdgeSides} [padToVisualEdge] - App shell prop.
    *
    * @param {boolean | import('@typhonjs-svelte/runtime-base/svelte/component/container').TJSScrollContainerData} [scrollContainer] - App
    *        shell prop.
    *
    * @returns {({
    *    padToVisualEdgeActual?: import('@typhonjs-svelte/runtime-base/svelte/action/dom/style').VisualEdgeSides,
    *    scrollContainerActual?: boolean | import('@typhonjs-svelte/runtime-base/svelte/component/container').TJSScrollContainerData
   ...
   static handlePadScrollOptions(padToVisualEdge, scrollContainer)
   {
      ...
      /** @type {import('@typhonjs-svelte/runtime-base/svelte/component/container').TJSScrollContainerData} */
