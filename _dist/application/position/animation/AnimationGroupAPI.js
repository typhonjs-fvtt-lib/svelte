 ...
 * checks are not done against Position. Instead a simple check of using `object.constructor.name` equalling position
 * is used below in {@link AnimationGroupAPI.#isPosition}.
 *
 * @see AnimationAPI
 */
