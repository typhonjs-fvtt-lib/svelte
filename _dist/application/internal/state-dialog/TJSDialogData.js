...
export class TJSDialogData
{
   ...
   /**
    * @returns {import('@typhonjs-svelte/runtime-base/svelte/util').TJSSvelteConfig | string} The Svelte configuration object or HTML string
    *          content.
    */
   get content()
   {
    ...
    *
    * @param {import('@typhonjs-svelte/runtime-base/svelte/util').TJSSvelteConfig | string} content - New Svelte configuration object or
    *        HTML string content.
    */
   set content(content)
   {
