...
export class TJSAppIndex
{
    ...
    *
    * @type {Map<string, import('@typhonjs-fvtt/svelte/application').SvelteApplication>}
    */
    ...
    *
    * @param {import('@typhonjs-fvtt/svelte/application').SvelteApplication} app - A SvelteApplication
    *
    * @package
    */
   static add(app)
    ...
    *
    * @returns {import('@typhonjs-fvtt/svelte/application').SvelteApplication} Associated app.
    */
   static get(key)
   {
   ...
   /**
    * @returns {IterableIterator<import('@typhonjs-fvtt/svelte/application').SvelteApplication>} All visible apps.
    */
   static values()
   {
