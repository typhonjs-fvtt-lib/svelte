...
import { propertyStore }         from '#svelte-fvtt/store/derived';

import { TJSSessionStorage }     from '#svelte-fvtt/store/storage/web';
...
export class SvelteReactive
{
   ...
   /** @type {import('#svelte-fvtt/store/storage/web').TJSSessionStorage} */
   #sessionStorage;
...
// Store getters -----------------------------------------------------------------------------------------------------
   ...
   /**
    * @returns {import('#svelte-fvtt/store/storage/web').TJSSessionStorage} Returns TJSSessionStorage instance.
    */
   get sessionStorage()
   {
