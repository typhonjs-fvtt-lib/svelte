<script>
    ...
    *
    * @type {boolean | import('#runtime/svelte/component/container').TJSScrollContainerData}
    */
    ...
    *
    * @type {import('#runtime/svelte/action/dom/style').VisualEdgeSides | undefined}
    */
    ...
    *
    * @type {boolean | import('#runtime/svelte/component/container').TJSScrollContainerData | undefined}
    */
